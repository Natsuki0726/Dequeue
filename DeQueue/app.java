...
public class app {
	...
	private static final String HOST = "172.30.212.25"; // Host name or IP address
	private static final int PORT = 1414; // Listener port for your queue manager
	private static final String CHANNEL = "DEV.APP.SVRCONN"; // Channel name
	private static final String QMGR = "demoqueuemanager"; // Queue manager name
    ...
    private static void Db2Insert(String input)  {
        // DB2データベースへの接続情報
        String jdbcUrl = "jdbc:db2://172.30.3.137:50000/testdb";
        String user = "db2inst1";
        String password = "cicdtest";
